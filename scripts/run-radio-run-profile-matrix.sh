...
keys = [
    ...
    "channel", "bandwidth_mhz", "tx_power_mode", "tx_power_index",
    "tx_power_path", "tx_calibration_profile",
    "radio_run_config",
...
run_one_profile() {
  ...
  export TX_POWER_MODE TX_POWER_INDEX TX_POWER_PATH TX_CALIBRATION_PROFILE ENABLE_M2L ENABLE_L2M M2L_FEC_K
