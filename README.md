...
- Read RTL8812AU registers, EFUSE, guarded power-on/RF-reset writes, and LLT programming through macOS IOUSBHost default-control transfers when macOS has not created libusb-visible interfaces.
