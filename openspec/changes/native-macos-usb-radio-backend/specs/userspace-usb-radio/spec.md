...
- **THEN** the system can issue bounded RTL8812AU vendor control reads and guarded control-write diagnostics while clearly reporting that bulk RX/TX endpoint access is not proven
