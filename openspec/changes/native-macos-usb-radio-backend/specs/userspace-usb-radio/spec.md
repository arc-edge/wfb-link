...
- **THEN** the system can issue bounded RTL8812AU vendor control reads, guarded EFUSE control sequences, and guarded power-on/RF-reset control-write diagnostics while clearly reporting that bulk RX/TX endpoint access is not proven
