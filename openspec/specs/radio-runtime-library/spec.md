...
The runtime library SHALL provide report-neutral RTL8812AU IQK setup,
candidate-selection, and TX/RX IQC fill-plan helpers for calibration callers.
...
- **WHEN** the diagnostic runtime-IQK command builds candidate and IQC fill
  reports
- **THEN** it calls the runtime planning helpers and remains responsible only
  for live sweep orchestration and report formatting
