# Radio Verification Specification

## Purpose

Define staged diagnostics and machine-readable reports that prove each hardware-facing radio capability independently before full WFB operation is trusted.
