# Runtime TX Handler Specification

## Purpose

Define runtime-owned processing for one queued production WFB TX datagram,
including parsing, TX option resolution, descriptor preview metadata, radio
submission, and report-neutral counters.
