# Development Bring-Up Notes

This is the original long-form README content. It is preserved as a historical
bring-up journal and diagnostic command reference. The concise project overview
now lives in the repository root [README](../../README.md).
