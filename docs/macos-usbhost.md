...
The remaining macOS 26 proof target is no longer basic RF visibility, low-rate WFB interoperability, or sustained packet flow at `-l 1000`; it is real video/telemetry workload stability and full-duplex bridge operation.
