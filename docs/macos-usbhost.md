...
The remaining macOS 26 proof target is no longer basic RF visibility, low-rate WFB interoperability, sustained packet flow at `-l 1000`, or bounded full-duplex bridge operation; it is real video/telemetry workload stability.
