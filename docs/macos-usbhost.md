...
The remaining macOS 26 proof target is no longer basic RF visibility, low-rate WFB interoperability, sustained packet flow at `-l 1000`, bounded full-duplex bridge operation, multi-port bridge plumbing, stock WFB-ng aggregator compatibility, or encoded H.264/RTP packet delivery. The remaining work is widening the RF operating modes and replacing planted/calibrated TX power behavior with explicit EFUSE-derived controls.
